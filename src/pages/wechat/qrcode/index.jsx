    ...
    render() {
        ...
        return (
            ...
            <div>
                        ...
                        <Form.Item label='公众号'>
                            ...
                            >
                                {this.state.optionArray != '' && this.state.optionArray != null ? this.state.optionArray.map((item, index) => {
                                    return <Option value={item.name} onClick={this.getTitle.bind(this, item.title)}>{item.title}</Option>
                                }) : ''}
                            </Select>)
                            }
                        </Form.Item>
                ...
                <Table columns={columns} dataSource={this.state.dataArray != null && this.state.dataArray.length > 0 ? this.state.dataArray : ''} />
            </div>
        )
    }
}
